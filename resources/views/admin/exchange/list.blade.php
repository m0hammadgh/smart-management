        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-6 text-end">
                    <a class="btn btn-success" href="{{route('exchange.add')}}">افزودن</a>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($list as $item)
                                        <tr>
                                            ...
                                            <td class="text-center" >{!! getBladeImage($item->icon,'exchange') !!}</td>
                                            <td class="text-center">
                                                <a href="{{route('exchange.edit',[$item->id])}}"><i class="fa fa-edit"></i></a>
                                                <a class="delete-item" href="{{route('exchange.delete',[$item->id])}}"><i class="fa fa-remove"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
