        ...
        <div class="row">
            ...
            <div class="col-xl-7 p-0">
                <div class="login-card">
                    <form method="post" action="{{route('login.do')}}" class="theme-form login-form">
                        @csrf
                        <h6> وارد حساب کاربری خود شوید.</h6>
                        <div class="form-group">
                            <label>نام کاربری  </label>
                            <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                                <input class="form-control" name="user_name" type="text" required="" placeholder="نام کاربری">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            </div><a class="link" href="forget-password.html">رمز عبور را فراموش کرده اید؟</a>
                        </div>
                        <div class="form-group"><input class="btn btn-primary btn-block"  type="submit" value="ورود"></div>
