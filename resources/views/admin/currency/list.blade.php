...
@section('title',' رمز ارزها ')
@section('page')
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3>لیست رمز ارز ها</h3>

                </div>
                <div class="col-sm-6 text-end">
                    <a class="btn btn-success" href="{{route('currency.add')}}">افزودن</a>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center"  scope="col">نماد</th>
                                    ...
                                    @foreach($list as $item)
                                        <tr>
                                            ...
                                            <td class="text-center" >{{$item->persian_name ?? '' }}</td>
                                            <td class="text-center" >{{$item->title ?? '' }}</td>
                                            <td class="text-center" >{{$item->short_name ?? '' }}</td>
                                            <td class="text-center" >{!! getBladeImage($item->icon,'currency') !!}</td>
                                            <td class="text-center">
                                                <a href="{{route('currency.edit',[$item->id])}}"><i class="fa fa-edit"></i></a>
                                                <a class="delete-item" href="{{route('currency.delete',[$item->id])}}"><i class="fa fa-remove"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
