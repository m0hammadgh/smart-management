        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-6 text-end">
                    <a class="btn btn-success" href="{{route('user.new')}}">افزودن</a>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center"  scope="col">تلفن</th>
                                    ...
                                    @foreach($list as $item)
                                        <tr>
                                            ...
                                            <td class="text-center" >{!! getUserStatus($item->status) !!}</td>
                                            <td class="text-center">
                                                <a href="{{route('user.edit',[$item->id])}}"><i class="fa fa-edit"></i></a>
                                                <a class="delete-item" href="{{route('user.delete',[$item->id])}}"><i class="fa fa-remove"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
