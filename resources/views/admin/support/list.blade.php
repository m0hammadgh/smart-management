...
@section('title','گروه های پشتیبانی')
@section('page')
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3>لیست گروه های پشتیبانی</h3>

                </div>
                <div class="col-sm-6 text-end">
                    <a class="btn btn-success" href="{{route('ticketCategory.add')}}">افزودن</a>
                                    ...
                                    @foreach($list as $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('ticketCategory.edit',[$item->id])}}"><i class="fa fa-edit"></i></a>
                                                <a class="delete-item" href="{{route('ticketCategory.delete',[$item->id])}}"><i class="fa fa-remove"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
