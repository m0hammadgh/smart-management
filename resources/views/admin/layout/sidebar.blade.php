<div class="main-navbar" style="height: 100%;">
    <div id="mainnav" style="height: 100%;">
        <ul class="nav-menu custom-scrollbar" style="display: block;height: 100%;">
            <li class="back-btn">
            ...
            <li class="dropdown">
                <a class="nav-link menu-title link-nav" href="/admin/dashboard">
                    ...
                    <span>داشبورد</span>
                    <div class="according-menu"><i class="fa fa-dashboard"></i></div>
                </a>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="nav-submenu menu-content" style="display: none;">
                    ...
                    <li><a href="{{route('admin.new')}}"> ایجاد مدیر جدید </a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a class="nav-link menu-title" href="javascript:void(0)">
                ...
                <ul class="nav-submenu menu-content" style="display: none;">
                    <li><a href="{{route('user.index')}}">لیست </a></li>
                    <li><a href="{{route('user.new')}}">جدید</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a class="nav-link menu-title link-nav" href="{{route('document.list')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <span>درخواست های تایید مدارک</span>
            ...
            <li class="dropdown">
                <a class="nav-link menu-title link-nav" href="#">
                    ...
                    <span>تراکنش ها</span>
                    <div class="according-menu"><i class="fa fa-list"></i></div>
                </a>
            </li>
        </ul>
    </div>
