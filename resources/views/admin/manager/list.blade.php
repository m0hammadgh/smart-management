        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-6 text-end">
                    <a class="btn btn-success" href="{{route('admin.new')}}">افزودن</a>
                                ...
                                <table class="table">
                                    ...
                                    @foreach($list as $item)
                                        <tr>
                                            ...
                                            <td class="text-center" >{!! getAdminAccess($item->active) !!}</td>
                                            <td class="text-center">
                                                <a href="{{route('admin.edit',[$item->id])}}"><i class="fa fa-edit"></i></a>
                                                <a class="delete-item" href="{{route('admin.delete',[$item->id])}}"><i class="fa fa-remove"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
