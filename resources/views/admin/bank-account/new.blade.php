...
@section('title',' حساب بانکی کاربران')
@section('page')
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-6">
                    <h3>درخواست های تایید حساب بانکی</h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="needs-validation" novalidate="" method="post" enctype="multipart/form-data"
                              action="@if(isset($edit)) {{route('bank.update',$edit->id)}} @else {{route('bank.store')}} @endif">

                            @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label" for="validationCustom01">عنوان بانک</label>
