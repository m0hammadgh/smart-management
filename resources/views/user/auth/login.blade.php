...
<section>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-5"><img class="bg-img-cover bg-center" src="/assets/mirror/images/login/3.jpg"
                                       alt="صفحه ورود"></div>
            <div class="col-xl-7 p-0">
                <div class="login-card">
                    <form method="post" action="{{route('user.login.do')}}" class="theme-form login-form">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                ...
                                <label class="text-muted" for="checkbox1">رمز عبور را به خاطر بسپار</label>
                            </div>
                        ...
                        <div class="form-group"><input class="btn btn-primary btn-block" type="submit" value="ورود">
                        </div>
                        <hr/>
                        <div class="form-group text-center">
                            <a class="link" href="{{route('user.register')}}">حساب کاربری ندارید ؟ ثبت نام کنید</a>
