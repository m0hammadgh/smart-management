        ...
        <div class="row">
            ...
            <div class="col-xl-7 p-0">
                <div class="login-card">
                    <form method="post" action="{{route('user.verify.mobile.do',$uuid)}}" class="theme-form login-form">
                        @csrf
                        <h6> کد ارسالی به شماره {{$mobile}}  را وارد کنید </h6>
                        ...
                        <div class="form-group"><input class="btn btn-primary btn-block" type="submit" value="تایید">
                        </div>
